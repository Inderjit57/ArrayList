...
public class EmployeeMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("Employee name: " +arraylist.get(arraylist.indexOf(accountA)).getEmployeeName() + " \nID: "+arraylist.get(arraylist.indexOf(accountA)).getEmployeeID() + " \nMonthly salary: "+arraylist.get(arraylist.indexOf(accountA)).getMonthlySalary());
		System.out.println("Employee name: " +arraylist.get(arraylist.indexOf(accountB)).getEmployeeName() + " \nID: "+arraylist.get(arraylist.indexOf(accountB)).getEmployeeID() + " \nMonthly salary: "+arraylist.get(arraylist.indexOf(accountB)).getMonthlySalary());
		System.out.println("Employee name: " +arraylist.get(arraylist.indexOf(accountC)).getEmployeeName() + " \nID: "+arraylist.get(arraylist.indexOf(accountC)).getEmployeeID() + " \nMonthly salary: "+arraylist.get(arraylist.indexOf(accountC)).getMonthlySalary());
